...
def process_data(config: Config) -> None:
    ...
    dvc_remote_repo = "https://github.com/torresv1/cybulde-data2.git"
    dvc_data_folder = "data/raw"
    github_user_name = "torresv1"
    github_access_token = access_secret_version("emkademy-vladimir", "cybulde-data-github-access-token")
