...
from cybulde.config_schemas.infrastrutucture.cgp_schema import GCPConfig
...
class DataProcessingConfig:
    ...
    dvc_remote_repo: str = "https://github.com/torresv1/cybulde-data2.git"
    dvc_data_folder: str = "data/raw"
    github_user_name: str = "torresv1"
